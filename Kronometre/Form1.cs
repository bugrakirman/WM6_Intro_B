...
namespace Kronometre
{
    public partial class Form1 : Form
    {
        ...
        private void Yaz()
        {
            ...
            lblMs.Text = $"{kronometre.Millisecond:000}";
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (cbZamanli.Checked)
            {
                ...
                {
                    yuzde = 100;
                    kronometre = new DateTime(kronometre.Year,kronometre.Month,kronometre.Day,kronometre.Hour,
                        kronometre.Minute,kronometre.Second);
